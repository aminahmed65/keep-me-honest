        ...
        return """
{
  ...
  "vocabulary": {
    ...
    // People (proper name corrections from speech recognition)
    "Reda": ["reta", "reda", "retta"]
  ...
  "rules": {
    ...
    // People (exact spelling as written)
    "Reda": { "caseMode": "exact" }
...
"""
    ...
    private func createDefaultGlossary() -> VocabularyGlossary {
        let defaultMap: [String: [String]] = [
            ...
            // People (proper name corrections)
            "Reda": ["reta", "reda", "retta"]
        ]
        ...
        let defaultRules: [String: CanonRule] = [
            ...
            // People (exact spelling)
            "Reda": CanonRule(caseMode: .exact)
        ]
